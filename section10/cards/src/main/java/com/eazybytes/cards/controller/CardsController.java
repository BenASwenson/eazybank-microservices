...
@Tag(
        ...
        description = "CRUD REST APIs in EazyBank to CREATE, READ, UPDATE and DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "Contact Info that can be reached in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
